...
func TestRun_NoBuildInfo_PrintsVersionLineOnly(t *testing.T) {
	...
	// When
	err := version.ExportRun(t.Context(), opts)
	// Then
	if err != nil {
...
func TestFlagParsing_VerboseFlag_SetsVerboseTrue(t *testing.T) {
	...
	// When
	err := cmd.Run(t.Context(), []string{"version", "--verbose"})
	// Then
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestFlagParsing_JSONFlag_SetsJSONTrue(t *testing.T) {
	...
	// When
	err := cmd.Run(t.Context(), []string{"version", "--json"})
	// Then
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestFlagParsing_JSONFlag_DefaultIsFalse(t *testing.T) {
	...
	// When
	err := cmd.Run(t.Context(), []string{"version"})
	// Then
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
